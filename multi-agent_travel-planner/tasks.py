...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="A detailed 7-day travel itinerary with daily activities, accommodation recommendations, dining options, and budget estimates."
        )
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        """
            ...
            agent=agent,
            expected_output="A detailed analysis and recommendation for the best city to visit, including flight costs, weather information, and key attractions."
        )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="A comprehensive city guide including attractions, local customs, special events, activity recommendations, weather information, and estimated costs."
        )